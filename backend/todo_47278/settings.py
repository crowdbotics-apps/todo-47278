"""
Django settings for todo_47278 project.
...
WSGI_APPLICATION = 'todo_47278.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "todo_47278 API",
    "DESCRIPTION": "API documentation for todo_47278 App",
    "VERSION": "v1",
}
